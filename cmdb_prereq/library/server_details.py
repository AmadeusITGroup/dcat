...
def cmdb_fetch(conn_str,server_name,cmdb_server,user_name,pass_word,instance_id):
    ...
    ############# checking the status reason part ###################
                    ...
                    if status_of_server == "Deco in Progress": #"In Production" 
                        final_msg ="You are good to proceed with deco for server " + server_name + "."
                    else:
                        final_msg = "The server "+server_name+" is Not in production status."+" Kindly check with application team"
                        ...
                        if response.status_code != requests.codes.ok:
                            ...
                            if len(entries)== 1:
                                ...
                                if status_of_server == "Deco in Progress": #"In Production"
                                    ...
                                    final_msg = "The server "+server_name+" is Not in Production."+" Kindly check with application team"
                            elif len(entries)== 0:
