...
def rearrange_data(swt_cisco):
    input_data = {
        "cisco_out_formatted": swt_cisco
    }

    data_lines = input_data["cisco_out_formatted"].split("\n")

    output = ""
    grouped_data = {}

    for line in data_lines:
        if line.startswith("muc"):
            current_group = line
...
# swt_cisco = "muc-az2-cl-1104l:\n - Ethernet7/1 : bhg40012\n - Po1071 : bhg40012\nmuc-az2-cl-1104r:\n - Ethernet7/1 : bhg40012\n - Po1071 : bhg40012\n\nmuc-az2-cl-1104l:\n - Ethernet7/3 : bhp40159\n - Po1073 : bhp40159\nmuc-az2-cl-1104r:\n - Ethernet7/3 : bhp40159\n - Po1073 : bhp40159"

# output = rearrange_data(swt_cisco)
# print(output)
...
def main():
    returnValue = {}
    fields = {
        "swt_cisco": {"required": True, "type": "str"}
    }
    module = AnsibleModule(argument_spec=fields)

    try:
        res = rearrange_data(module.params["swt_cisco"])
