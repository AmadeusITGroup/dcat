...
EXAMPLES = r'''
    - name: Implementation partial that is closing the implementation as partial
        ...
        register: job_status
'''
def job(url,username,password,ci,cr,graceperiod_flag,ritm_number,retention_days,requester_name,requester_group,pillar,mit_ticket):
    host = ""
    for x in ci:
        host += str(" - "+"hosts:"+" "+"'"+x+"'"+"\r\n")
        time.sleep(1)
    url="https://"+ url +"/api/v2/workflow_job_templates/29083/launch/"    
    #headers={"Content-Type":"application/json"}
    #data = {"name": "VM Deco Auto DCAT","description": "VM Deco Auto DCAT","job_type": "run","inventory": 1457,"project": 10890,"playbook": "playbooks/launch_dev_deco.yml","scm_branch": "","forks": 5,"limit": "","verbosity": 0,"extra_vars": "---","job_tags": "","force_handlers": "false","skip_tags": "","start_at_task": "","timeout": 0,"use_fact_cache": "false","execution_environment": 4,"host_config_key": "","ask_scm_branch_on_launch": "false","ask_diff_mode_on_launch": "false","ask_variables_on_launch": "true","ask_limit_on_launch": "false","ask_tags_on_launch": "false","ask_skip_tags_on_launch": "false","ask_job_type_on_launch": "false","ask_verbosity_on_launch": "false","ask_inventory_on_launch": "false","ask_credential_on_launch": "false","ask_execution_environment_on_launch": "false","ask_labels_on_launch": "false","ask_forks_on_launch": "false","ask_job_slice_count_on_launch": "false","ask_timeout_on_launch": "false","ask_instance_groups_on_launch": "false","survey_enabled": "false","become_enabled": "false","diff_mode": "false","allow_simultaneous": "true","job_slice_count": 1,"webhook_service": "","webhook_credential": "null","prevent_instance_group_fallback": "false"}
...
def main():
    ...
    try:
        status = job(module.params["url"],module.params["username"],module.params["password"],
                        module.params["ci"],module.params["cr"],module.params["graceperiod_flag"],
                        module.params["ritm_number"],module.params["retention_days"],
                        module.params["requester_name"],module.params["requester_group"],module.params["pillar"],module.params["mit_ticket"])
