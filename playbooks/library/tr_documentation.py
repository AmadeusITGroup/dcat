...
'''
def tr_overview(win_url,username,password,task_id):
    url="https://"+ win_url +"/aproach-api/v1.0/taskrecords/"+ task_id
    headers={"Content-Type":"application/json"}
    data1={"operation": "tr_categorized_as_doc",
            "taskRecord": {"normalFields": { "SystemCategory" :"P" }}}
